//
//  BroadcastByCategoryRequest.swift
//  Latvijas Radio
//
...
class BroadcastByCategoryRequest {

    static let TAG = String(describing: BroadcastByCategoryRequest.self)
    ...
    func createQuery() {
        ...
        let url = URL(string: Configuration.API_URL + "/broadcast-by-category")!
