//
//  EpisodeSubscriptionStatusGetRequest.swift
//  Latvijas Radio
//
...
class EpisodeSubscriptionStatusGetRequest {

    static let TAG = String(describing: EpisodeSubscriptionStatusGetRequest.self)
    ...
    func createQuery(_ episodeId: String) {
        ...
        GeneralUtils.log(EpisodeSubscriptionStatusGetRequest.TAG, url)
        ...
        task = session.dataTask(with: request) { data, response, error in
            DispatchQueue.main.async(execute: {
                ...
                if let responseJson = responseJson as? [String: Any] {
                    ...
                    //GeneralUtils.log(EpisodeSubscriptionStatusGetRequest.TAG, String(data: data, encoding: .utf8)!)
