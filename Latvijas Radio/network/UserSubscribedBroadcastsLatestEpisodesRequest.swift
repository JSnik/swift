//
//  UserSubscribedBroadcastsLatestEpisodesRequest.swift
//  Latvijas Radio
//
...
class UserSubscribedBroadcastsLatestEpisodesRequest {

    static let TAG = String(describing: UserSubscribedBroadcastsLatestEpisodesRequest.self)
    ...
    func createQuery() {
        ...
        let url = URL(string: Configuration.API_URL + "/user/subscribed-broadcasts/latest-episodes")!
        
        GeneralUtils.log(UserSubscribedBroadcastsRequest.TAG, url)
        ...
        task = URLSession.shared.dataTask(with: request) { data, response, error in
            DispatchQueue.main.async(execute: {
                ...
                if let responseJson = responseJson as? [String: Any] {
                    ...
                    //GeneralUtils.log(UserSubscribedBroadcastsRequest.TAG, String(data: data, encoding: .utf8)!)
