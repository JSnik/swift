...
class Asset {
    ...
    init(episodeModel: EpisodeModel, urlAsset: AVURLAsset) {
...
/// Used in "cancelDownload".
extension Asset: Equatable {
    static func ==(lhs: Asset, rhs: Asset) -> Bool {
        return (lhs.episodeModel.getId() == rhs.episodeModel.getId()) && (lhs.urlAsset == rhs.urlAsset)
    }
}
...
extension Asset {
    struct Keys {
        /**
         ...
         AssetListManager.
         */
        static let assetEpisodeId = "AssetEpisodeIdKey"
