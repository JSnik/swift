...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    static var TAG = String(describing: SceneDelegate.self)
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // handle universal link when app is not running
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        BroadcastsViewController.needsUpdate = true
    }
    
    static func getSceneDelegate() -> SceneDelegate? {
        var result: SceneDelegate?
        
        for scene in UIApplication.shared.connectedScenes {
            if let sceneDelegate: SceneDelegate = (scene.delegate as? SceneDelegate) {
                result = sceneDelegate
